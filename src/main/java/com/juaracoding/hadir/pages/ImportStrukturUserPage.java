...
public class ImportStrukturUserPage {
    ...
    private By submenuImportStrukturUserLocator = By.xpath("//p[normalize-space(text())='Import Struktur User']");
    ...
    // === Klik submenu Import StrukturUser ===
    public void clickSubmenuImportStrukturUser() {
        driver.findElement(submenuImportStrukturUserLocator).click();
    }
