...
public class ImportStatusAktifPage {
    ...
    private By submenuImportStatusAktifLocator = By.xpath("//p[normalize-space()='Import Status Aktif']");

    // --- Locator Upload & Button ---
    private By fileInputLocator = By.xpath("//input[@type='file']");
    private By importButtonLocator = By.xpath("//button[contains(text(),'Import')]");
    private By downloadTemplateButtonLocator = By.xpath("//button[contains(text(),'Download Template')]");
    ...
    public ImportStatusAktifPage(WebDriver driver) {
        this.driver = driver;
    ...
    // === Klik submenu Import Status Aktif ===
    public void clickSubmenuImportStatusAktif() {
        driver.findElement(submenuImportStatusAktifLocator).click();
    }
